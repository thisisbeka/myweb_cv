    ...
    <section className="relative pb-16 md:pb-20 px-6 overflow-hidden">
      ...
      <div className="max-w-6xl mx-auto relative z-10">
        ...
        <div className="grid grid-cols-3 gap-4 md:gap-8">
          <StatCard
            icon={<img src="/woman-student-svgrepo-com.svg" alt="Experience" className="w-8 h-8 md:w-10 md:h-10" />}
            number={4}
          ...
          />
          <StatCard
            icon={<img src="/medal-reward-svgrepo-com.svg" alt="Projects" className="w-8 h-8 md:w-10 md:h-10" />}
            number={50}
          ...
          />
          <StatCard
            icon={<img src="/customer-svgrepo-com.svg" alt="Clients" className="w-8 h-8 md:w-10 md:h-10" />}
            number={100}
...
function StatCard({ icon, number, label, suffix = '' }: StatCardProps) {
